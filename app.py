...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    if not compare_mode:
        ...
        fig_traj.add_vline(x=2022, line_dash="dot", line_color="gray", annotation_text="Last historical data (2022)", annotation_position="top left", annotation_text="Last historical data (2022)", annotation_position="top left",
        ...
        fig_traj_comp.add_vline(x=2022, line_dash="dot", line_color="gray", annotation_text="Last historical data (2022)", annotation_position="top left", annotation_text="Last historical data (2022)", annotation_position="top left",
                                annotation_text="Last historical data point (2022)",
                                annotation_position="top left")
